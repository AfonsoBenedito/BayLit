...
const ProdutoHistoricoSchema = new Schema({
...
}, {collection: 'ProdutoHistorico'});

const UserEvents = Trigger(ProdutoHistoricoSchema, {
    events: {
      create: true
    }
});

let ProdutoHistorico = mongoose.model('ProdutoHistorico', ProdutoHistoricoSchema);
module.exports = ProdutoHistorico;
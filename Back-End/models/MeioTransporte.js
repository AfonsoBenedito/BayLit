...
const MeioTransporteSchema = new Schema({
...
}, {collection: 'MeioTransporte'});

let MeioTransporte = mongoose.model('MeioTransporte', MeioTransporteSchema);
module.exports = MeioTransporte;